...
const Layout = () => {
  ...
  const getUsers = async () => {
    ...
    try {
      const res = await axios.get(`${API_URL}/users/list-admin-prodi`, {
        params: {
          search: keyword,
          page: page,
          limit: limit,
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold mb-4 dark:text-white">Data Pegawai</h2>
                  ...
                  >
                    ...
                    <td className="px-4 py-3 whitespace-nowrap">
                      <div className="flex gap-x-2">
                        <ButtonAction
                          to={`/users/edit/${user.id}/admin`}
                          icon={<MdEditSquare />}
                          className={"bg-blue-600 hover:bg-blue-700"}
                        />
                        <ButtonAction
                          to={`/users/${user.id}/details/admin`}
