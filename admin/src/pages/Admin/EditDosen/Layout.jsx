      ...
      try {
        ...
        if (res.data && res.data.result) {
          ...
          setFormData({
            ...
            prodi: data.prodi || "",
            pendidikanTerakhir: data.detailDosen[0].pendidikanTerakhir || "",
            tahun: data.detailDosen[0].tahun || "",
            gol: data.detailDosen[0].gol || "",
            tmtGolongan: data.detailDosen[0].tmtGolongan || "",
            tmtJabatan: data.detailDosen[0].tmtJabatan || "",
            jabatan: data.detailDosen[0].jabatan || "",
            agama: data.detailDosen[0].agama || "",
          });
        }
