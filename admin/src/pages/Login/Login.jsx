    ...
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 sm:p-8">
      <div className="max-w-md w-full m-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="bg-blue-700 py-8 px-6 text-center">
          <h1 className="text-3xl font-bold text-white mb-2">Office Administration</h1>
          <p className="text-blue-100">Management System Portal</p>
        </div>
            ...
            <div className="relative">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full pt-5 pb-2 text-sm border-0 border-b-2 border-gray-300 focus:border-blue-600 focus:outline-none focus:ring-0"
                />
