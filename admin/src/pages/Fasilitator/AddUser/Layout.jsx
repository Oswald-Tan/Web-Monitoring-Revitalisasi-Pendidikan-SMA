  ...
  <div className="space-y-2">
    ...
    <div className="relative">
      ...
      <input
        ...
        className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-xl shadow-sm bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 hover:border-gray-400 text-sm"
      />
      {showPasswordToggle && (
        <button
          type="button"
      ...
      <div className="space-y-6 w-full">
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500">
            Passwords must be at least 8 characters long and include both
            letters and numbers
          </p>
        </div>
      </div>
