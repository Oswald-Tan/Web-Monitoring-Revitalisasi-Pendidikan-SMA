...
const Layout = () => {
  ...
  const loadReview = (review) => {
    ...
    // Set data review yang sudah ada
                  ...
                  <tbody>
                    ...
                    <tr className="bg-gray-100">
                      ...
                      <td
                        ...
                        colSpan="1"
                      >
                        {formatNumber(reviewData.totals.volume)}
                      </td>
                      <td
                        className="border border-gray-300 px-4 py-2 font-semibold text-xs text-right"
                        colSpan="1"
                      ...
                      <td
                        ...
                        colSpan="1"
                      >
                        {formatNumber(reviewData.totals.bobot)}
                      </td>
                      <td
                        className="border border-gray-300 px-4 py-2 font-semibold text-xs text-right"
                        colSpan="1"
                      >
                        {formatNumber(reviewData.totals.sdMingguLaluVolume)}
                      </td>
                      <td
                        className="border border-gray-300 px-4 py-2 font-semibold text-xs text-right"
                        colSpan="1"
                      >
                        {formatNumber(reviewData.totals.sdMingguLaluBobot)}
                      </td>
                      <td
                        className="border border-gray-300 px-4 py-2 font-semibold text-xs text-right"
                        colSpan="1"
                      >
                        {formatNumber(reviewData.totals.dalamMingguIniVolume)}
                      </td>
                      <td
                        className="border border-gray-300 px-4 py-2 font-semibold text-xs text-right"
                        colSpan="1"
                      >
                        {formatNumber(reviewData.totals.dalamMingguIniBobot)}
                      </td>
                      <td
                        className="border border-gray-300 px-4 py-2 font-semibold text-xs text-right"
                        colSpan="1"
                      >
                        {formatNumber(reviewData.totals.sdMingguIniVolume)}
                      </td>
                      <td
                        className="border border-gray-300 px-4 py-2 font-semibold text-xs text-right"
                        colSpan="1"
                      >
                        {formatNumber(reviewData.totals.sdMingguIniBobot)}
                      </td>
                      <td
                        className="border border-gray-300 px-4 py-2 font-semibold text-xs text-right"
                        colSpan="1"
                      >
                        {formatNumber(reviewData.totals.bobotMasing)}
                      </td>
                      <td
                        className="border border-gray-300 px-4 py-2 font-semibold text-xs text-right"
                        colSpan="1"
