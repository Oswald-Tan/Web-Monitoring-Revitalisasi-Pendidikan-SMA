// Frontend: Layout.jsx (Komponen Laporan Bulanan)
...
const Layout = () => {
  ...
  const fetchMonthlyReports = async () => {
    ...
    try {
      ...
      const reportsWithExtras = response.data.data.map((report) => ({
        ...report,
        plannedProgress: report.data ? report.data.plannedProgress || 0 : 0,
        variance: report.data ? report.data.variance || 0 : 0,
        // Pastikan kita menggunakan data.weeklyReviews yang berisi array semua minggu
