...
const SidebarKoordinator = () => {
  ...
  useEffect(() => {
    ...
    const updatedMenus = [
      {
        name: "Dashboard",
        link: "/koordinator/dashboard",
        icon: TbLayoutDashboard,
      },
      {
        name: "Sekolah",
        link: "/koordinator/sekolah",
        icon: LuSchool,
      },
      {
        name: "Monitoring",
        ...
        hasSubMenu: true,
        subMenu: [
          { name: "Review Input Harian", link: "/koordinator/monitoring/input-harian-review" },
          { name: "Review Mingguan", link: "/koordinator/monitoring/reviu-mingguan" },
        ],
      },
      {
        name: "Laporan Bulanan",
        link: "/koordinator/pelaporan/laporan-bulanan",
        icon: LuList,
      },
      {
        name: "Koordinasi",
        ...
        subMenu: [
          {
            ...
            link: "/koordinator/koordinasi/kalender-kegiatan",
          },
          { name: "Forum Diskusi", link: "/koordinator/forum-diskusi" },
        ],
      },
      {
        name: "Dokumen",
        link: "/koordinator/dokumen/template-sop",
        icon: RiFileCopy2Line,
      },
      {
        name: "Manajemen Tim",
        link: "/koordinator/manajemen-tim/profil-personel",
        icon: BiGroup,
      },
      {
        name: "Pengaturan Akun",
        link: "/koordinator/pengaturan/profil-akun",
        icon: LuSettings,
      },
      {
        name: "Logout",
