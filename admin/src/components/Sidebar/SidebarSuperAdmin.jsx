  ...
  useEffect(() => {
    ...
    const updatedMenus = [
      ...
      },
      {
        ...
        hasSubMenu: true,
        subMenu: [
          { name: "Input Harian", link: "/super-admin/monitoring/input-harian" },
          { name: "Reviu Mingguan", link: "/super-admin/monitoring/reviu-mingguan" },
        ],
      },
      {
        name: "Pelaporan",
        ...
        hasSubMenu: true,
        subMenu: [
          { name: "Laporan Bulanan", link: "/super-admin/pelaporan/laporan-bulanan" },
          { name: "Laporan Akhir", link: "/super-admin/pelaporan/laporan-akhir" },
        ],
      },
      {
        name: "Koordinasi",
        ...
        subMenu: [
          {
            ...
            link: "/super-admin/koordinasi/kalender-kegiatan",
          },
          { name: "Forum Diskusi", link: "/super-admin/forum-diskusi" },
        ],
      },
      {
        name: "Dokumen",
        link: "/super-admin/dokumen/template-sop",
        ...
        subMenu: [
          {
            ...
            link: "/super-admin/manajemen-tim/profil-personel",
          },
          { name: "Pembagian Tugas", link: "/super-admin/manajemen-tim/pembagian-tugas" },
        ],
        icon: BiGroup,
      },
      {
        ...
        hasSubMenu: true,
        subMenu: [
          { name: "Profil Akun", link: "/super-admin/pengaturan/profil-akun" },
          { name: "Hak Akses", link: "/super-admin/pengaturan/hak-akses" },
        ],
        icon: LuSettings,
      },
      {
