...
const SidebarFasilitator = () => {
  ...
  useEffect(() => {
    ...
    const updatedMenus = [
      {
        name: "Dashboard",
        link: "/fasilitator/dashboard",
        icon: TbLayoutDashboard,
      },
      {
        name: "Sekolah",
        link: "/fasilitator/sekolah",
        icon: LuSchool,
      },
      {
        name: "Input Harian",
        icon: LuMonitor,
        link: "/fasilitator/monitoring/input-harian",
      },
      {
        name: "Forum Diskusi",
        icon: HiOutlineDocumentText,
        link: "/fasilitator/forum-diskusi",
      },
      {
        name: "Dokumen",
        link: "/fasilitator/dokumen/template-sop",
        icon: RiFileCopy2Line,
      },
      {
        name: "Profil Akun",
        icon: LuSettings,
        link: "/fasilitator/pengaturan/profil-akun"
      },
      {
        name: "Logout",
        action: () => logout(),
